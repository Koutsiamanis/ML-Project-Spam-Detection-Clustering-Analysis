...
- **Cluster 2**: Μαθητές με **υψηλές επιδόσεις**, με σκορ περίπου 1 τυπική απόκλιση πάνω από το μέσο όρο σε όλα τα μαθήματα. Πρόκειται για τους πιο ικανούς μαθητές του δείγματος.
![](k-means.png)
...
plt.show()
```
Mε την χρήση του παραπάνω κώδικα δημιουργούμε το δενδρόγραμμα έτσι ώστε να επιλέξουμε τον κατάλληλο αριθμό συστάδων. Η μέθοδος σύνδεσης που χρησιμοποιήθηκε ήταν η **Ward linkage** με **Ευκλείδεια απόσταση**.
![](dendrogramma.png)
...
![](Agglomerative%20Clustering3d.png)
...
```
![](k-distanceGraph.png)
Παρατηρώντας το γράφημα, η απότομη αύξηση γίνεται περίπου στο ύψος eps ≈ 0.4.
```python
import pandas as pd
from sklearn.preprocessing import StandardScaler
