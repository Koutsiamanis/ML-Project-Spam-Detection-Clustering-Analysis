...
df_apriori.to_csv("C:/Users/patatakis/Desktop/odep/StudentsPerformance_categorical.csv", index=False)

df_loaded = pd.read_csv("C:/Users/patatakis/Desktop/odep/StudentsPerformance_categorical.csv")
